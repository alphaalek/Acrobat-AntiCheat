package me.alek.acrobat.netty.modelwrappers.nbt;

import me.alek.acrobat.netty.modelwrappers.nbt.lists.NBTList;
import me.alek.acrobat.netty.modelwrappers.nbt.lists.NBTListOfCompound;
import me.alek.acrobat.netty.modelwrappers.nbt.lists.NBTListOfList;
import me.alek.acrobat.netty.structure.ReflectStructure;
import me.alek.acrobat.netty.structure.converters.ApplicableConverter;
...
import me.alek.acrobat.netty.structure.converters.ListConverter;
...
public abstract class NBTAbstractList<T extends NBTBase<?, ?>> extends NBTBase<List<Object>, ListConverter<Object, T>>implements Iterable<T> {
    ...
    public void write(DataOutput output) throws Exception {
        ...
        for (T value : getValue().getDelegatedList()) {
            value.write(output);
        }
    }
